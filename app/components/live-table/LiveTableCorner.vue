...
/**
 * The top-left panel every table hangs its reference material off — paytables,
 * the baccarat roadmap, rule reminders. Dimmed and collapsed to its header by
 * default so it never competes with the hands, and it brightens on hover.
 *
...
<template>
    <div class="lt-corner" :class="{ open: expanded }" :style="{ top: `${62 + offset}px` }">
