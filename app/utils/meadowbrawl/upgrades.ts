...
export const UPGRADES: UpgradeDef[] = [
    ...
    boon('static', 'Static Charge', 'rare', 'effect', 5, 'i-lucide-zap', 'Hits charge the target: +8% crit against it', { element: 'shock' }),
    ...
    boon('sprintcharge', 'Bull Rush', 'rare', 'effect', 3, 'i-lucide-zap', 'Sprinting into foes sends them flying'),
    ...
    boon('lightning', 'Chain Lightning', 'epic', 'effect', 3, 'i-lucide-cloud-lightning', '35% chance a hit arcs to neighbours. Stacks jump farther', { element: 'shock' }),
