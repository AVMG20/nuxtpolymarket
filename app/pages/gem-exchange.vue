        ...
        <div v-else class="grid grid-cols-2 divide-x divide-default">
          ...
          <div>
            ...
            <button
                ...
                :key="`bid-${level.price}`"
                type="button"
                class="relative flex w-full justify-between px-4 py-1.5 text-sm tabular-nums transition-colors hover:bg-success/10 focus-visible:outline-2 focus-visible:outline-offset-[-2px] focus-visible:outline-success"
          ...
          <div>
            ...
            <button
                ...
                :key="`ask-${level.price}`"
                type="button"
                class="relative flex w-full justify-between px-4 py-1.5 text-sm tabular-nums transition-colors hover:bg-error/10 focus-visible:outline-2 focus-visible:outline-offset-[-2px] focus-visible:outline-error"
