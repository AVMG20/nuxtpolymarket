...
CREATE TABLE "meadowbrawl_state" (
	...
	"vitality_level" integer DEFAULT 0 NOT NULL,
	"tempering_level" integer DEFAULT 0 NOT NULL,
	"nimble_level" integer DEFAULT 0 NOT NULL,
	"fortune_level" integer DEFAULT 0 NOT NULL,
