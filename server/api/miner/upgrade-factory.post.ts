...
import { factoryRate, factoryCap, factoryUpgradeCost, computePending, FACTORY_MAX_LEVEL } from './_config'
import { debit, getBalance } from '../../utils/balance'
...
export default defineEventHandler(async (event) => {
  ...
  await debit(userId, cost.toFixed(4), 'miner:upgrade-factory')
  if (collectedGems >= 1) {
