...
export const SPN_BUY_BONUS_COST = 80 // × bet: skip straight to free spins
...
// Weighted random: [2, 4, 6, 10, 15]× bet with weights [45, 30, 15, 7, 3].
// Avg ~4.15× per piñata → ~17× bet per triggered FS → contributes ~3.5% RTP.
export const PINATA_POT_PRIZES  = [2,  4,  6, 10, 15]   // × bet
