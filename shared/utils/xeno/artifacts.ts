...
export const ARTIFACT_TYPES: ArtifactType[] = [
  // ─── Grid: speed boost (pure) ────────────────────────────────────────────
  {
    ...
    name: 'Speed Rune',
    emoji: '⚡',
    description: 'Grid: −20% grow time. Best for early cycling.',
    maxCharges: 10,
    effects: [{ type: 'grid_speed_boost', value: 0.20 }],
  ...
  },
  {
    ...
    name: 'Speed Rune II',
    emoji: '⚡',
    description: 'Grid: −50% grow time. Significant cycle reduction.',
    maxCharges: 11,
  ...
  },
  {
    ...
    name: 'Speed Rune III',
    emoji: '⚡',
    description: 'Grid: −80% grow time. Best pure speed artifact in the game.',
    maxCharges: 13,
    effects: [{ type: 'grid_speed_boost', value: 0.80 }],
  ...
  },
  {
    ...
    emoji: '🔷',
    description: 'Grid: −30% grow time & +2 yield. Solid T3 hybrid.',
    maxCharges: 12,
    effects: [
      { type: 'grid_speed_boost', value: 0.30 },
  ...
  },
  {
    ...
    emoji: '🔷',
    description: 'Grid: −40% grow time & +3 yield. Premium T5 hybrid with max charges. Pure artifacts exceed it in their single stat.',
    maxCharges: 14,
    effects: [
      { type: 'grid_speed_boost', value: 0.40 },
